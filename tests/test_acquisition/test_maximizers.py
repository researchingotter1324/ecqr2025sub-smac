...
def configspace_branin() -> ConfigurationSpace:
    ...
    cs.add(UniformFloatHyperparameter("x", -5, 10))
    cs.add(UniformFloatHyperparameter("y", 0, 15))
    return cs
...
def configspace() -> ConfigurationSpace:
    ...
    a = UniformFloatHyperparameter("a", 0, 1, default_value=0.5)
    b = UniformFloatHyperparameter("b", 0, 1, default_value=0.5)
    c = UniformFloatHyperparameter("c", 0, 1, default_value=0.5)
...
def configspace_categorical() -> ConfigurationSpace:
    ...
    a = CategoricalHyperparameter("a", ["c1", "c2", "c3"])
    b = CategoricalHyperparameter("b", ["c1", "c2", "c3", "c4"])
    c = UniformFloatHyperparameter("c", 0, 1, default_value=0.5)
...
def configspace_prior():
    ...
    x2 = NormalIntegerHyperparameter("x2", lower=-5, upper=5, mu=5, sigma=1, default_value=5)
