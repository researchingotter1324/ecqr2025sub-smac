...
from ConfigSpace import (
    ...
    Configuration,
    ConfigurationSpace,
    NormalUniformFloatHyperparameter,
    NormalUniformIntegerHyperparameter,
...
class MLP:
    ...
    def prior_configspace(self) -> ConfigurationSpace:
        ...
        # And place a Normal Prior skewed towards wider networks in log space
        n_neurons = NormalIntegerHyperparameter(
            "n_neurons",
            lower=8,
            upper=256,
            mu=128,
