...
class Scenario:
    ...
    def save(self) -> None:
        ...
        from ConfigSpace.read_and_write.json import write as write_json
        with open(configspace_filename, "w") as fh:
            fh.write(write_json(self.configspace))
    ...
    def load(path: Path) -> Scenario:
        ...
        with open(configspace_filename, "r") as fh:
            configspace = read_json(fh.read())
